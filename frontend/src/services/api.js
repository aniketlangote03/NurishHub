...
// The base URL must point to your backend API. E.g., https://nurishhub-2.onrender.com/api
const API_BASE = import.meta.env.VITE_API_URL || 'https://nurishhub-2.onrender.com/api';
